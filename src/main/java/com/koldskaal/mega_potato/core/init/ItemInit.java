...
public class ItemInit {
    ...
    public static final DeferredItem<PotatoToolItem> POTATO_HAMMER_ITEM = ITEMS.registerItem(
            "potato_hammer",
            PotatoToolItem::new,
            new Item.Properties().stacksTo(1)
    );
    public static final DeferredItem<PotatoToolItem> POTATO_SQUEEZER_ITEM = ITEMS.registerItem(
            "potato_squeezer",
            PotatoToolItem::new,
            new Item.Properties().stacksTo(1)
    );
